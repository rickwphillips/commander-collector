...
- **Countering the Knowledge Pool trigger saves the hand spell.** If you counter the KP trigger *before it resolves*, the hand spell is NOT exiled — the exile is an effect of the trigger when it resolves, not a consequence of the trigger firing. Counter the trigger → the hand spell resolves normally. (The previously stated "was already exiled" was incorrect.) Conversely, if you counter the *hand spell* (not the KP trigger) before the KP trigger resolves, the KP trigger still resolves but the hand spell is already gone — the trigger's "may cast from exile" does nothing. (Knowledge Pool ruling 2011-06-01: "If the original spell isn't exiled... the rest of the ability does nothing.")
- **Knowledge Pool exiles "can't be countered" spells.** Knowledge Pool doesn't counter the hand spell — it exiles it. Even spells that "can't be countered by spells or abilities" are still exiled by Knowledge Pool, because exiling isn't countering. The spell never resolves because it's been exiled. (Knowledge Pool ruling 2011-06-01: "The spell a player casts from their hand won't resolve if it's exiled, even if that spell can't be countered by spells or abilities.")
