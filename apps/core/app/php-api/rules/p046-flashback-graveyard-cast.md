...
- **A card put in the graveyard without being cast can still be flashed back.** There is no requirement that the card was cast before arriving in the graveyard. (Gatherer ruling 2021-03-19: "You can cast a spell using flashback even if it was somehow put into your graveyard without having been cast.")
- **A card with no mana cost that gains flashback has no flashback cost — it cannot be cast via flashback.** Flashback cost equals the original mana cost when granted via Snapcaster-style effects. If the card has no mana cost, there is no cost to pay and it cannot be cast this way. (Gatherer ruling 2021-03-19: "If a card with no mana cost gains flashback, it has no flashback cost. It can't be cast this way.")
- **If a split card gains flashback, you pay only the cost of the half you're casting.** (Gatherer ruling 2021-03-19)
- **A flashback spell "bounced" to hand is still exiled.** If an effect returns a flashback spell to its owner's hand while it's on the stack (e.g., Venser, Shaper Savant), the exile replacement still fires — "wherever it would go, exile it instead" applies even when the destination would be the hand. The spell goes to exile, not back to the hand or graveyard. (Gatherer ruling 2021-03-19 on Venser: "If Venser's triggered ability targets a spell cast with flashback, that spell will be exiled instead of returning to its owner's hand.")
- **Flashback is an alternative cost; you cannot also pay another alternative cost when casting via flashback.** For example, you can't overload a spell via flashback — overload is also an alternative cost, and CR 118.9a allows only one. You CAN pay additional costs (kicker, entwine, buyback) on top of the flashback cost. Mandatory additional costs must be paid. (Gatherer ruling 2021-03-19: "If you cast a spell with flashback, you can't pay any alternative costs such as overload costs. You can pay additional costs such as kicker costs. If the spell has any mandatory additional costs, you must pay those to cast the spell with flashback.")
