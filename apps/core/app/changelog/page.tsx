...
const releases: Release[] = [
  ...
  },
  {
    ...
    changes: [
      { type: 'added', text: 'Rules Guru suggests questions based on most recently updated patterns — generated by AI and cached to DB' },
      { type: 'improved', text: 'Suggested questions update automatically when new patterns are added, without regenerating on every load' },
    ],
  },
  {
    version: '3.0.0',
